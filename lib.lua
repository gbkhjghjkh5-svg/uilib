-- // Lib \\ --
--[[
    local UI = loadstring(game:HttpGet("https://europium.best/assets/files/gayasf.ui2?key=5y1lxXSfWKhlQkSqhUuFyB8kPp8hsCau"))()
]]
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    ...
    Utility.SaveConfig = function(Config)
        ...
        writefile(
            "europium/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local CFG = HttpService:JSONDecode(readfile("europium/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Window.SetText(0, "loading..")
        --
        Utility.AddFolder("europium")
        Utility.AddFolder("europium/Caches")
        Utility.AddFolder("europium/Assets")
        Utility.AddFolder("europium/Assets/UI")
        Utility.AddFolder("europium/Configs")
        Utility.AddFolder("europium/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("europium/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("europium/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("europium/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("europium/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("europium/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Dummy = Utility.AddImage("europium/Assets/UI/Dummy.png", "https://i.imgur.com/6M6buVv.png")
        --
        if not isfolder("europium/Configs/" .. game.PlaceId) then
            makefolder("europium/Configs/" .. game.PlaceId)
        end
        --
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:TextBox(Options)
                    ...
                    InputHandler.Name = ("europium-INPUT-%s"):format(HttpService:GenerateGUID(false))
                    --
